...
private void processRegExZipCode(){
       ...
       // String regex_1 = "[t|T]";
		...
		//String zipCode = "234567898";
		String zipCode = "A1A1A1";
		
		System.out.println("Start process zipCode");
		...
		//System.out.println(zipCode.replaceAll("(\\d{3})(\\d{3})(\\d{4})", "($1) $2-$3"));
		System.out.println(zipCode.replaceAll("(\\w{1})(\\d{1})(\\w{1})(\\d{1})(\\w{1})(\\d{1})", "$1$2$3 $4$5$6"));
		
		// replace all whitespace with tabs
	  //  System.out.println(zipCode.replaceAll("\\s+", "\t"));
		
		//System.out.println(zipCode);
		
	}
	
private void processRegExZipCode2(){
