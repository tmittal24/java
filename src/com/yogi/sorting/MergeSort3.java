...
public class MergeSort3 {
	...
	public static void main(String[] args) {
		...
		MergeSort3 t = new MergeSort3();
		
		int[] s = {23,34,56,7,8,3,33,55,87};
	...
	// post: array is sorted in ascending order (lowest to highest)
	{
		...
		if (array.length > 1) {
			...
			// since we want an even split, we initialize the length of
			// sub-array 2 to
			// equal the length of sub-array 1
			int elementsInA2 = elementsInA1;
			// if the array has an odd number of elements, let the second half
			// take the extra one
			// see note (1)
			if ((array.length % 2) == 1)
				elementsInA2 += 1;
